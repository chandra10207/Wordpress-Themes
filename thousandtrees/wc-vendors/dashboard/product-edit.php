...
<form method="post" action="" id="wcv-product-edit" class="wcv-form wcv-formvalidator"> 
	...
	<input id="deal_package" class="deal_" type="checkbox" <?php if ( isset($deal_package) && $deal_package == 1) {echo 'checked';}else {echo '';}?> name="deal_package" value="1" onchange="valueChanged()" />
		<label for="deal_package"> Add a Deal</label>
		<br>
		...
		<label for="deal_per_night"> Add per night price</label>
		<br>
		...
		<label for="deal_per_person"> Add per person price</label>
	...
	<div class="wcv-product-basic wcv-product"> 
		...
		<p><span>Please fill out the additional details of the deals like what’s included and what’s not.</span></p>
		...
		<?php 
			$small_editor_args = array(
				...
				'media_buttons' => true,
				'post_id'   => $object_id,
				'placeholder' => __('Please fill', 'wcvendors-pro' ),
				'desc_tip' => true,
			...
			//WCVendors_Pro_Product_Form::short_description( $object_id, $small_editor_args ); 
		?> 
...
<!-- sunil code -->
	...
	<?php 
	  WCVendors_Pro_Form_Helper::input( array(  
		 ...
		 'label'    => __( 'Discount Percentage', 'wcvendors-pro' ), 
		 ...
		 'custom_attributes' => array( 
		 		...
		 		'max' => 100,
	 			'data-rules' => 'required', 
	 			'data-error' => __( 'This is a required field and not more than 100.', 'wcvendors-pro' )
	 		)
		) ); 
		 ...
		 'placeholder'   => __( 'Enter Start date', 'wcvendors-pro' ), 
		 'desc_tip'    => 'true', 
		 'description'   => __( 'Date of Start', 'wcvendors-pro' ), 
		 'custom_attributes' => array( 
	 			'data-rules' => 'required', 
		...
		echo  '<label>Number of people</label>'; 
		 echo "<div class='row'><div class='col-md-6 tt-number-of adults'>";
		 ...
		 'desc_tip'    => 'true', 
		 'description'   => __( 'Insert how many adults are allowed', 'wcvendors-pro' ), 
		 'custom_attributes' => array(
			 'min' => 1,
	 			'data-rules' => 'required', 
	 			'data-error' => __( 'This is a required field.', 'wcvendors-pro' )
	...
	WCVendors_Pro_Form_Helper::input( array(
		...
		'post_id'   => $object_id,
		'id'     => 'wcv_adults_price',
		'label'    => __( 'Adults Price', 'wcvendors-pro' ),
		'placeholder'   => __( 'Adults Price', 'wcvendors-pro' ),
		'desc_tip'    => 'true',
		'description'   => __( 'Insert price for Adults', 'wcvendors-pro' ),
		'custom_attributes' => array(
			'min' => 1,
			'data-rules' => 'required',
			'data-error' => __( 'This is a required field.', 'wcvendors-pro' )
		   ...
		   echo "</div>";
		   echo "<div class='col-md-6 tt-number-of kids'>";
		 ...
		 'label'    => __( 'Kids', 'wcvendors-pro' ), 
		 'placeholder'   => __( 'Kids', 'wcvendors-pro' ), 
		 'desc_tip'    => 'true', 
		 'description'   => __( 'Insert how many kids are allowed', 'wcvendors-pro' )
	...
	WCVendors_Pro_Form_Helper::input( array(
		...
		'post_id'   => $object_id,
		'id'     => 'wcv_kids_price',
		'label'    => __( 'Kids Price', 'wcvendors-pro' ),
		'placeholder'   => __( 'Kids Price', 'wcvendors-pro' ),
		'desc_tip'    => 'true',
		'description'   => __( 'Insert price for Kids', 'wcvendors-pro' )
	) );
	...
	WCVendors_Pro_Form_Helper::select(
		array(
			'post_id'           => $object_id,
			'id'                => 'wcv_custom_product_smoking_deal',
			'label'             => __( 'Smoking Allowed', 'wcvendors-pro' ),
	...
	WCVendors_Pro_Form_Helper::select(
		array(
			'post_id'           => $object_id,
			'id'                => 'wcv_custom_product_pets_allowed',
			'label'             => __( 'Pets Allowed', 'wcvendors-pro' ),
			'wrapper_start'     => '<div class="all-100">',
			'wrapper_end'       => '</div>',
			'options'           => array(
				'Yes'       => __( 'Yes', 'wcvendors-pro' ),
	...
	<?php
		 ...
		 'placeholder'   => __( 'Enter Address', 'wcvendors-pro' ), 
		 'desc_tip'    => 'true', 
		...
		?>
		<div class="tt-hidden-fields" style="height:1px;width:100%;">
		<?php 
