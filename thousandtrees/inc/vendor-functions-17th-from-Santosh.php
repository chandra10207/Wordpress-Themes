...
?>
<?php
remove_action( 'woocommerce_single_product_image_thumbnail', 'woocommerce_show_product_thumbnails', 20 );
    ...
    function woocommerce_my_single_title()
    {
        ...
        <div class="product-details">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="pd-people">
                        <span><i class="fa fa-users" aria-hidden="true"></i> <?php echo $adults; ?> Adults &amp; <?php echo $kids; ?> Kids</span>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="pd-category">
                        <span><i class="fa fa-list-ul" aria-hidden="true"></i> Category: <?php echo "Per Deal Package" ?></span>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="pd-location">
                        <span><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo "Address Here" ?></span>
                    </div>
                </div>
            </div>
        </div>
