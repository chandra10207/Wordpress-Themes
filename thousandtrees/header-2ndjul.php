...
<body <?php body_class(); ?>>
    ...
    class="home" style="background-image:url(<?php echo get_theme_mod('thtrs_home_header_banner')?>);"
              ...
              <div class="col2-set" id="customer_login">
                      ...
                      <form method="post" class="login">
                          ...
                          <p class="form-row">
                              ...
                              <input type="submit" id="thou_login" class="button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
                      ...
                      <div>
                        ...
                        <form method="post" class="register">
                            ...
                            <p class="form-row">
                                ...
                                <input type="submit" id="reg_thousandtree" class="button" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
                            </p>
