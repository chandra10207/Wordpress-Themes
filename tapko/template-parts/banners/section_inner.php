<?php
// Get type
$block_type = get_theme_mod( 'my_setting_cho_' );
$item_link = '';
$image_url = '';

if ( $block_type == 'product' ) {
	$product_id = get_theme_mod( 'my_setting_product_' );
	if ( ! empty( $product_id ) ) {
	...
	$category_id = get_theme_mod( 'my_setting_category_' );
	$category_img = get_theme_mod( 'ad_category_image' );
   ...
   $ad_img = get_theme_mod( 'image_setting_ad_image_');
   $item_link = get_theme_mod( 'my_setting_ad_url_');
	   if(isset($ad_img)){
	   	$image_url = get_theme_mod( 'image_setting_ad_image_');
	   }
}
