...
// Get type
$block_type = get_theme_mod( 'my_setting_cho_10' );
$item_link = '';
$image_url = '';

if ( $block_type == 'product' ) {
	$product_id = get_theme_mod( 'my_setting_product_10' );
	if ( ! empty( $product_id ) ) {
	...
	$category_id = get_theme_mod( 'my_setting_category_10' );
	$category_img = get_theme_mod( 'image_category_image_10' );
   ...
   $ad_img = get_theme_mod( 'image_setting_ad_image_10');
   $item_link = get_theme_mod( 'my_setting_ad_url_10');
	   if(isset($ad_img)){
	   	$image_url = get_theme_mod( 'image_setting_ad_image_10');
	   }
}
